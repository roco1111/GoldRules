...
import com.rosario.hp.goldrules.utils.TimeFormatter;
...
public class DeviceActivity extends BaseActivity {
    ...
    private void appendDeviceInfo(final MergeAdapter adapter, final BluetoothLeDevice device) {
        ...
        final TextView textViewName = layout.findViewById(R.id.deviceName);
        final TextView textViewAddress = layout.findViewById(R.id.deviceAddress);
    ...
    private void appendIBeaconInfo(final MergeAdapter adapter, final IBeaconManufacturerData iBeaconData) {
        ...
        final TextView tvCompanyId =  lt.findViewById(R.id.companyId);
        final TextView tvUUID =  lt.findViewById(R.id.uuid);
        final TextView tvMajor =  lt.findViewById(R.id.major);
        final TextView tvMinor =  lt.findViewById(R.id.minor);
        final TextView tvTxPower = lt.findViewById(R.id.txpower);
    ...
    private void appendRssiInfo(final MergeAdapter adapter, final BluetoothLeDevice device) {
        ...
        final TextView tvLastTimestamp =  lt.findViewById(R.id.lastTimestamp);
        final TextView tvLastRssi = lt.findViewById(R.id.lastRssi);
