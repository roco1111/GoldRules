 ...
 */
public class activity_beacon extends AppCompatActivity implements View.OnClickListener, BeaconConsumer,
        RangeNotifier {

    protected final String TAG = activity_beacon.this.getClass().getSimpleName();;
    ...
    private TextView identificaciones;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        identificaciones = findViewById(R.id.identificaciones);
    }
    ...
    public void didRangeBeaconsInRegion(Collection<Beacon> beacons, Region region) {
        ...
        for (Beacon beacon : beacons) {
            identificacion.setText("1 - " + beacon.getIdentifier(0).toString());
            adress.setText("2 - " + beacon.getBluetoothAddress());
            id1.setText("3 - " + beacon.getId1().toString());
            id2.setText("4 - " + beacon.getId1().toString());
            id3.setText("5 - " + beacon.getId1().toString());
            identificaciones.setText("6 - " + beacon.getIdentifiers().toString());
